...
const HomeButton = ( props ) => (
 ...
 const SearchButton = ( props ) => (
  ...
  const DepartureButton = ( props ) => (
    ...
    onPress={props.onPress }
    >
      <Icon style={{}} name={props.accessibilityState.selected?'time':'time-outline'} size={props.accessibilityState.selected ? 20 : 15}  color={props.accessibilityState.selected?"#ebdbb2":"#a89984"} light={props.accessibilityState.selected}/>
  ...
  const NearbyStopsButton = ( props ) => (
    ...
    >
      <Icon style={{marginTop:0}} name={props.accessibilityState.selected?'location':'location-outline'} size={props.accessibilityState.selected ? 20 : 15}  color={props.accessibilityState.selected?"#ebdbb2":"#a89984"} light={props.accessibilityState.selected}/>
...
const App = () => {
  ...
  return (
      <NavigationContainer>
        <Stack.Navigator screenOptions={{headerShown:false, tabBarActiveBackgroundColor:"#363636", tabBarInactiveBackgroundColor:"#282828", tabBarActiveTintColor:"#ebdbb2", tabBarInactiveTintColor:"#a89984", tabBarStyle:{height:80,borderTopWidth:0,}}}>
